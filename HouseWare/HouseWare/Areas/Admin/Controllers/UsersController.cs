...
namespace HouseWare.Areas.Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,FullName,Address,UserName,Password,Phone,IdRole")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FullName,Address,UserName,Password,Phone,IdRole")] User user)
        {
            if (ModelState.IsValid)
            {
